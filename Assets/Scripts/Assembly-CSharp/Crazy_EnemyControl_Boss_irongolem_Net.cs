...
public class Crazy_EnemyControl_Boss_irongolem_Net : Crazy_EnemyControl_Boss_Net
{
	...
	{
		preStart();
		ReadStatus("irongolem_netskill", "irongolem_netstatus");
	...
	public void FallStore()
	{
		...
		else
		{
			...
			{
				_003C_003Ef__am_0024cache15 = _003CFallStore_003Em__C;
			}
	...
	[CompilerGenerated]
	private static int _003CFallStore_003Em__C(TNetUser a, TNetUser b)
	{
