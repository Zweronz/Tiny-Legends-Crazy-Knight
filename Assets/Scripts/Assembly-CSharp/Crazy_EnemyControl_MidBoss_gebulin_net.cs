...
public class Crazy_EnemyControl_MidBoss_gebulin_net : Crazy_EnemyControl_MidBoss_Net
{
	private void Start()
	{
		preStart();
	...
	public override Renderer[] FindMeshRenderer()
	{
		...
		{
			base.gameObject.transform.Find("goblin").gameObject.GetComponent<Renderer>(),
			base.gameObject.transform.Find("Object01").gameObject.GetComponent<Renderer>()
		};
	}
