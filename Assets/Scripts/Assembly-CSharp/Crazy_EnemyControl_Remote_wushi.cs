...
public class Crazy_EnemyControl_Remote_wushi : Crazy_EnemyControl_Remote
{
	private void Start()
	{
		preStart();
	...
	protected override void PlayAnimation(Crazy_MonsterStatus toStatus)
	{
		...
		case Crazy_MonsterStatus.Die:
			...
			{
				base.GetComponent<Animation>().CrossFade("adeath0" + 1 + "_merge", 0.1f);
				DieAway3();
			}
	...
	public override Renderer[] FindMeshRenderer()
	{
		...
		{
			base.gameObject.transform.Find("wushi").gameObject.GetComponent<Renderer>(),
			base.gameObject.transform.Find("weapon").gameObject.GetComponent<Renderer>()
		};
	}
	...
	protected override GameObject[] FindHeadNode()
	{
		...
		{
			base.gameObject.transform.Find("Dummy01/Dummy07/Dummy08").gameObject,
			base.gameObject.transform.Find("Dummy01/Dummy07/Dummy09").gameObject
		};
	}
}
