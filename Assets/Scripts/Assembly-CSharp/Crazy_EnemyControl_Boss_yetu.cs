...
public class Crazy_EnemyControl_Boss_yetu : Crazy_EnemyControl_MiddleBoss
{
	private void Start()
	{
		preStart();
	...
	{
		return new Renderer[1] { base.gameObject.transform.Find("monster01").gameObject.GetComponent<Renderer>() };
	}

	protected override GameObject[] FindHeadNode()
	{
		return new GameObject[1] { base.gameObject.transform.Find("Bone01/Dummy02/Dummy05").gameObject };
	}
}
