...
public class Crazy_EnemyControl_Boss_bianfu : Crazy_EnemyControl_MiddleBoss
{
	private void Start()
	{
		preStart();
	...
	{
		return new Renderer[1] { base.gameObject.transform.Find("Root/Dummy02").gameObject.GetComponent<Renderer>() };
	}
}
