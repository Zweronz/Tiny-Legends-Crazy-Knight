...
public class Crazy_EnemyControl_MidBoss_zhizhu_net : Crazy_EnemyControl_MidBoss_Net
{
	private void Start()
	{
		preStart();
	...
	{
		return new Renderer[1] { base.gameObject.transform.Find("zhizhu").gameObject.GetComponent<Renderer>() };
	}
	...
	protected override GameObject[] FindHeadNode()
	{
		...
		{
			base.gameObject.transform.Find("Root/Dummy02").gameObject,
			base.gameObject.transform.Find("Root/Dummy03").gameObject
		};
	}
}
