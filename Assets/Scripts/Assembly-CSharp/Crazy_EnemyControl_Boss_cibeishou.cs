...
public class Crazy_EnemyControl_Boss_cibeishou : Crazy_EnemyControl_MiddleBoss
{
	private void Start()
	{
		preStart();
	...
	{
		return new Renderer[1] { base.gameObject.transform.Find("monster02").gameObject.GetComponent<Renderer>() };
	}
