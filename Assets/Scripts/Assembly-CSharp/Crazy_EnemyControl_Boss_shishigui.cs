...
public class Crazy_EnemyControl_Boss_shishigui : Crazy_EnemyControl_MiddleBoss
{
	private void Start()
	{
		preStart();
	...
	{
		return new Renderer[1] { base.gameObject.transform.Find("ghoul").gameObject.GetComponent<Renderer>() };
	}
